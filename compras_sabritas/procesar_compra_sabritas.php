...
$consulta = "SELECT unidad FROM sabritas WHERE codigo_barras = '$codigo_de_barras'";
$resultado = $conexion->query($consulta);

if ($resultado->num_rows == 1) {
    $fila = $resultado->fetch_assoc();
    $unidades_actuales = $fila['unidad'];
} else {
...
$consulta = "UPDATE sabritas SET unidad = '$nuevas_unidades' WHERE codigo_barras = '$codigo_de_barras'";
...
$conexion->close();
header('Location: /store/sabritas.php');
exit;
