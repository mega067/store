...
$consulta = "SELECT unidades FROM prod_limpieza WHERE codigo_barras = '$codigo_de_barras'";
...
$consulta = "UPDATE prod_limpieza SET unidades = '$nuevas_unidades' WHERE codigo_barras = '$codigo_de_barras'";
...
$conexion->close();
header('Location: /store/prod_limpieza.php');
exit;
