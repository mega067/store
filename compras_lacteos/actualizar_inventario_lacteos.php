...
$consulta = "SELECT Unidades FROM lacteos WHERE codigo_barras = '$codigo_de_barras'";
...
$consulta = "UPDATE lacteos SET Unidades = '$nuevas_unidades' WHERE codigo_barras = '$codigo_de_barras'";
...
$conexion->close();
header('Location: /store/lacteos.php');
exit;
