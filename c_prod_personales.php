...
$consulta = "SELECT * FROM prod_personales";
...
if ($resultado->num_rows > 0) {
    ...
    while ($fila = $resultado->fetch_assoc()) {
        ...
        $ruta_imagen = "prod_personales_img/" . $nombre_producto . ".png";
        ...
        echo '<form action="
        compras_prod_personales/actualizar_inventario_per.php
        " method="post">';
        ...
        echo '<form action=
        "compras_prod_personales/procesar_compra_per.php" 
        method="post">';
        echo '<input type="hidden" name="codigo_de_barras" value="' . $codigo_de_barras . '">';
